...
resource "aws_nat_gateway" "nat" {
  ...
  subnet_id     = aws_subnet.public["10.0.1.0/24"].id # Use one of the public subnets
}
...
resource "aws_security_group" "ecs_sg" {
  ...
  ingress {
    from_port        = 50051  # Updated to 50051
    to_port          = 50051  # Updated to 50051
    protocol         = "tcp"
